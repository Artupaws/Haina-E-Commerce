package haina.ecommerce.view.restaurant.menu
...
class RestaurantMenuGalleryFragment :
    Fragment()
    ,AdapterRestaurantPhotoGallery.ItemAdapterCallback
{
    private lateinit var _binding: FragmentRestaurantMenuGalleryBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        _binding = FragmentRestaurantMenuGalleryBinding.inflate(inflater, container, false)
