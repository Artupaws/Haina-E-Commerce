...
class ProfilePostListPresenter(val view: ProfilePostListContract.View, val context: Context) {
    ...
    fun getListProfilePost(IdUser:Int,page:Int){
        view.showLoading()
        val getListForum = NetworkConfig().getConnectionHainaBearer(context).getUserPost(IdUser,"time",page)
